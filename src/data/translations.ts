      ...
      plans: {
        start: {
          ...
          features: [
            ...
            "Кнопка 'Позвонить / Написать в WhatsApp'",
            "Регистрация точки на Google Maps (Killer-Feature)",
          ],
        },
        base: {
          title: "Бизнес + AI",
          ...
          features: [
            ...
            "Форма онлайн-записи / Сложная кнопка связи",
            "Мультиязычность (EN/TR/RU)",
          ],
        },
        profi: {
      ...
      plans: {
        start: {
          ...
          features: [
            ...
            "WhatsApp Button (Direct Conversion)",
            "Google Maps Registration (Killer-Feature)",
          ],
        },
        base: {
          title: "Business + AI",
          ...
          features: [
            ...
            "AI Integration",
            "Online booking form / Complex contact button",
      ...
      plans: {
        start: {
          ...
          features: [
            ...
            "WhatsApp Butonu (Doğrudan Dönüşüm)",
            "Google Haritalar Kaydı (Killer-Feature)",
          ],
        },
        base: {
          title: "İş + AI",
          ...
          features: [
            ...
            "AI Entegrasyonu",
            "Online randevu formu / Karmaşık iletişim butonu",
            "Çok dillilik (EN/TR/RU)",
          ],
        },
        profi: {
